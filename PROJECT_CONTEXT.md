...
7. Add distributed fanout with NATS, Kafka, or Redpanda.
8. Add delivery and read receipts.
9. Add offline sync with pagination and per-device cursors.
10. Add end-to-end encryption protocol support.
